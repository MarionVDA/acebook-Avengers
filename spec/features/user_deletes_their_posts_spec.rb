...
RSpec.feature "delete posts", type: :feature do
  ...
  #
  #   user1 = User.create({email: "test123@gmail.com", password: "123456", username: "jojo123"})
  #   post1 = Post.create({message: "Hello", user_id: user1.id, username: "jojo123"})
  #   user2 = User.create({email: "test1234@gmail.com", password: "123456", username: "hapz2"})
  #   visit "/"
  #   click_link "Login"
